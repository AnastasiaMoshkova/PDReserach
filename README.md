...
- [Методика регистрации данных](#Методикарегистрацииданных)
- [Структура хранения данных](#Структурахраненияданных)
- [Environment](#Environment)
- [Очередность выполнения пайплайнов](#Очередностьвыполненияпайплайнов)
- [Описание экспериментов](#Описаниеэкспериментов)
- [Статьи по теме исследования](#Статьипотемеисследования )
